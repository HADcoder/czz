...
public class WebGen {
    ...
    public static void parse(String tableName) {
        ...
        sb.append("import com.jeeboot.core.base.BaseController;\r\n");
        sb.append("import com.jeeboot.entity."+GenTool.initcap(tableName)+";\r\n");
        sb.append("import com.jeeboot.message.ResponseMsg;\r\n");
        sb.append("import com.jeeboot.service."+GenTool.initcap(tableName)+"Service;\r\n");
        ...
        sb.append("\t@Autowired\r\n");
        sb.append("\tprivate " + GenTool.initcap(tableName) + "Service "+ GenTool.initcap2(tableName) +"Service;\r\n\r\n");
