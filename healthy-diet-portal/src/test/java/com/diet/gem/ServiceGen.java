...
public class ServiceGen {
    ...
    public static void parse(String tableName) {
        String svcName = GenTool.initcap(tableName) + "Service";
    ...
    private static void genSvc(String tableName, String svcName) {
        ...
        sb.append("import com.jeeboot.core.base.BaseService;\r\n");
    ...
    private static void genSvcImpl(String tableName, String svcName, String svcImplName) {
        ...
        sb.append("import com.jeeboot.core.base.impl.BaseServiceImpl;\r\n");
        sb.append("import com.jeeboot.entity." + GenTool.initcap(tableName) + ";\r\n");
