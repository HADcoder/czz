...
public class GenTool {
    ...
    public static String entityPackageOutPath = "com.diet.entity";//指定实体生成所在包的路径
    public static String daoPackageOutPath = "com.diet.dao";//指定Dao所在包的路径
    public static String svcPackageOutPath = "com.diet.service";//指定service接口所在包的路径
    public static String svcImplPackageOutPath = "com.diet.service.impl";//指定service实现所在包的路径
    public static String webPackageOutPath = "com.diet.controller";//指定Controller实现所在包的路径
    public static String authorName = "LiuYu";//作者名字

    //数据库连接
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/healthy_diet_admin?characterEncoding=utf8";
    ...
    private static final String SQL = "SELECT table_name AS tableName, column_name AS columnName, data_type AS dataType, " +
            ...
            "WHERE table_schema ='healthy_diet_admin' AND table_name LIKE '%s' ORDER BY table_name ASC, ordinal_position ASC;";

    public static void main(String[] args) throws Exception {
//        entityPackageOutPath = "com.diet.entity.sys";
//        daoPackageOutPath = "com.diet.dao.sys";
//        svcPackageOutPath = "com.diet.service.sys";
//        svcImplPackageOutPath = "com.diet.service.sys.impl";
//        webPackageOutPath = "com.diet.controller.sys";
        gen("tb_recipe_info%", true, false, false, false, "tb_");
    }
