 ...
 */ 
@RestController
@RequestMapping(BaseController.API + "/sysUser")
public class SysUserController extends BaseController {
	...
	@PostMapping("/save")
	public ResponseMsg insert(@RequestBody SysUser model) {
		ResponseMsg responseMsg = new ResponseMsg();
		SysUser result = sysUserService.save(model);
	...
	public ResponseMsg list(@RequestBody JSONObject request) {
		...
		Page<SysUser> result = sysUserService.findAll(pageable);
		responseMsg.setData(result);
		return responseMsg;
	}
